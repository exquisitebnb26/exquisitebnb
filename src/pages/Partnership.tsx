    ...
    <Layout>
      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-28 bg-charcoal relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-cream mb-8 animate-fade-in max-w-4xl mx-auto leading-tight">
            Elevate Your Property. <br className="hidden md:block" />
            Partner With Purpose.
          </h1>
          <p className="text-cream-muted text-lg md:text-xl max-w-2xl mx-auto animate-fade-in leading-relaxed">
      ...
      {/* Why Partner Section */}
      <section className="py-20 lg:py-28 bg-charcoal-light">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="p-8 bg-card border border-border hover:border-gold/30 transition-colors duration-300">
              <Shield className="w-8 h-8 text-gold mb-4" />
              <h3 className="text-xl font-serif text-cream mb-3">Trust Over Transactions</h3>
            ...
            <div className="p-8 bg-card border border-border hover:border-gold/30 transition-colors duration-300">
              ...
              <h3 className="text-xl font-serif text-cream mb-3">Long-Term Value</h3>
              <p className="text-cream-muted text-sm leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {[
              ...
              <div key={index} className="text-center p-6">
                ...
                <h3 className="text-lg font-serif text-cream mb-3">{item.title}</h3>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={index} className="flex gap-4 p-6 bg-card border border-border hover:border-gold/30 transition-colors duration-300">
                <item.icon className="w-6 h-6 text-gold flex-shrink-0 mt-1" />
                <div>
                  <h3 className="text-lg font-serif text-cream mb-2">{item.title}</h3>
                  <p className="text-cream-muted text-sm leading-relaxed">{item.description}</p>
                </div>
              </div>
            ))}
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={index} className="flex items-start gap-3">
                    ...
                    <span className="text-cream-muted leading-relaxed">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="lg:pl-8 lg:border-l lg:border-border">
              <p className="text-cream-muted/60 text-sm tracking-[0.2em] uppercase mb-4">
                A Gentle Note
              </p>
      ...
      <section className="py-24 lg:py-32 bg-charcoal relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12 text-center relative z-10">
          <h2 className="text-3xl md:text-4xl font-serif text-cream mb-6 max-w-2xl mx-auto">
